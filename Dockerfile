...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y g++ make liblua5.1-0-dev zlib1g-dev wget libtinyxml-dev lua-5.1 liblua5.1-filesystem0 liblua5.1-socket2
